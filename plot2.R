...
> 
> ## making plot
> plot(globalpowerset$Time,as.numeric(as.character(globalpowerset$Global_active_power)),type="l",main="Global Active Power Vs Time",xlab="",ylab="Global Active Power (kilowatts)") 
> 
> 
